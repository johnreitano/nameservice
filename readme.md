...
[Github Pages Setings](https://github.com/(johnreitano/nameservice/settings/)

After you do that you can visit your chain's UI at:

https://johnreitano.github.io/nameservice
...
In order for Docker images and Raspberry Pi images to build successfully, please add your docker hub credentials as [secrets](https://github.com/johnreitano/nameservice/settings/secrets/actions)
